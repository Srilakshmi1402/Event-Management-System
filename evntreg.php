...
<html lang="en">
  ...
  <head>
    ...
    <title>Book Ticket | Tech Fest 2022</title>
  ...
  <body class="animated fadeIn">
    ...
    <nav class="navbar navbar-toggleable-md navbar-light fixed-top bg-faded">
	    	...
	    	<a class="navbar-brand"><span><img src="images/images.png" height="30" width="33"></span>&nbsp; <strong>Tech Fest 2020 </strong></a>
    ...
    <div class="container animated fadeIn">
          ...
          <div class="card-block">
            ...
            <form method="post" action="">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="evntname">EVENT NAME:</label>
                <input type="text" class="form-control" id="evntname"   placeholder="Enter the event name" name="evnt" required="true">
              </div>
      ...
      <section id="footer">
      <hr>
        <marquee><p class="" style="font-size: 14px;">SRM University AP Amaravati  Tech Fest 2022</p></marquee>
      </section>
    </div> 
    <script src="https://code.jquery.com/jquery-3.1.1.slim.min.js" integrity="sha384-A7FZj7v+d/sdmMqp/nOQwliLvUsJfDHW+k9Omg/a/EheAdgtzNs3hpfag6Ed950n" crossorigin="anonymous"></script>
