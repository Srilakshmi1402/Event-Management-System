...
<html lang="en">
  ...
  <head>
    ...
    <title>Ticket | Tech Fest 2022</title>
  ...
  <body>
          ...
          <div class="container">
            <div class="card">
              ...
              <div class="card-block" style="background-color: #f0f0f0;">
                <h4 class="card-title"><i class="fa fa-id-card-o" aria-hidden="true"></i> &nbsp;<b> Tech Fest 2020</b></h4>
                <hr>
                <div class="row">
    ...
    <hr>
      <footer class="">
        <p><span><img src="images/images.png" height="22" width="25"></span>&nbsp; <strong>Tech Fest 2020</strong> | SRM University AP</p>
      </footer>
    </div>
